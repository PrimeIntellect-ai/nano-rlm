...
LONG_RUN_NOTE_SECONDS = (
    60.0  # a blocking run() at least this long earns a one-line note
)
MAX_LONG_RUN_NOTES = 3  # per agent; after that the habit is the model's choice
