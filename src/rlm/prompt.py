...
def build_system_prompt(
    ...
    *,
    ...
    parts: list[str] = [
        ...
        "original user inputs. `h.child_session_dirs` lists spawned child session paths: "
        "`history(h.child_session_dirs[0])` reads a child's live history. Call `history(...)` again for a "
